...
class UnsupportedMethodExeption: public HTTPProxyException {
 public:
  UnsupportedMethodExeption() throw() {}
  UnsupportedMethodExeption(const std::string& message) throw() : HTTPProxyException(message) {}
};
...
class HTTPServerException: public HTTPProxyException {
 public:
  HTTPServerException() throw() {}
  HTTPServerException(const std::string& message) throw() : HTTPProxyException(message) {}
};

...
/* Wrappers around HTTPHeader methods
 */
  void addHeader (const std::string& name, const std::string& value) {requestHeader.addHeader(name, value);}
  void addHeader (const std::string& name, const int value) {requestHeader.addHeader(name,value);}
  void removeHeader (const std::string& name) {requestHeader.removeHeader(name);}
  const HTTPHeader& getHeader() const {return requestHeader;}
 ...
 */
  ...
  const std::string& getClientIPAddress() const {return clientIPAddress;}
/**
 ...
 */
  ...
  std::ostream& forward(std::ostream &os, bool toServer) const;
